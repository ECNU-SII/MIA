...
export TTRL_AGENT_BASE="TTRL_AGENT_BASE/proxy/5000"
...
export STREAMING_PORT="8765"

PROJECT_NAME="deepreseach"
EXPERIMENT_NAME=""


SAVE_CHECKPOINT_DIR="/your_path/TTRL-streaming/verl_checkpoints"
REF_MODEL_PATH="/your_path/planner"
...
PYTHONUNBUFFERED=1 python3 streaming_ttrl_server.py \
